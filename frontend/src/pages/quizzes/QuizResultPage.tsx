...
const QuizResultPage = () => {
    ...
    const getScoreColor = (score: number) => {
        if (score >= 80) return 'from-emerald-500 to-teal-500 dark:from-teal-500 dark:to-blue-600';
            ...
            >
                <div className="mb-6">
                    <Link
                        ...
                        className="group inline-flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-teal-400 transition-colors duration-300"
                    >
                        <ArrowLeft
                ...
                <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-2 border-slate-200 dark:border-white/10 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-black/30 p-8 mb-8">
                    <div className="text-center space-y-6">
                        <div className="inline-flex items-center justify-center w-15 h-15 rounded-2xl bg-linear-to-br from-emerald-100 to-teal-100 dark:from-teal-900/50 dark:to-blue-900/50 shadow-lg shadow-emerald-500/20 dark:shadow-teal-500/20">
                            <Trophy
                        ...
                        <div className="flex items-center justify-center gap-4 pt-4">
                            <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 rounded-xl">
                                <Target
                ...
                <div className="space-y-6">
                    ...
                    {results.map((res, ind) => {
                        ...
                        return (
                            <div
                                key={ind}
                                className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-2 border-slate-200 dark:border-white/10 rounded-2xl p-6 shadow-lg shadow-slate-200/50 dark:shadow-black/30"
                            >
                                <div className="flex items-start justify-between gap-4 mb-3">
                                    <div className="flex-1">
                                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 rounded-lg mb-3">
                                    ...
                                    <div
                                        className={`shrink-0 w-10 h-10 rounded-xl flex items-center justify-center ${
                                            is_Correct
                                                ...
                                                : 'bg-rose-50 dark:bg-rose-900/20 border-2 border-rose-200 dark:border-rose-800'
                                        }`}
                                    >
                                        {is_Correct ? (
                                            <CheckCircle2
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`relative px-4 py-3 rounded-lg border-2 transition-all duration-200 ${
                                                    isCorrectOption
                                                        ? 'bg-emerald-50 dark:bg-emerald-900/20 border-emerald-300 dark:border-emerald-700 shadow-lg shadow-emerald-500/30 dark:shadow-emerald-500/10'
                                                        : isWrongAns
                                                ...
                                                <div className="flex items-center justify-between gap-3">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        {isUserSelected && (
                                                            <span
                                                                className={`inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-semibold ${
                                                                    isCorrectOption
                                                                        ? 'bg-emerald-100 dark:bg-emerald-900/50 border border-emerald-300 dark:border-emerald-700 text-emerald-700 dark:text-emerald-300'
                                                                        : 'bg-rose-100 dark:bg-rose-900/50 border border-rose-300 dark:border-rose-700 text-rose-700 dark:text-rose-300'
                                                                }`}
                                                            >
                                                        ...
                                                        {isCorrectOption && !isUserSelected && (
                                                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 dark:bg-emerald-900/50 border border-emerald-300 dark:border-emerald-700 rounded-lg text-xs font-semibold text-emerald-700 dark:text-emerald-300">
                                                                ✓ Correct Answer
                                                            </span>
                                                        )}
                                                    </div>
                                ...
                                {res.explanation && (
                                    <div className="p-4 bg-linear-to-br from-slate-50 to-teal-100/50 dark:from-slate-900/50 dark:to-teal-900/20 border border-slate-200 dark:border-white/10 rounded-xl">
                                        <div className="flex items-start gap-3">
                                            <div className="shrink-0 w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-700 flex items-center justify-center mt-0.5">
                                                <BookOpen
                                                    className="w-4 h-4 text-slate-600 dark:text-slate-400"
                                                    strokeWidth={2}
                                                />
